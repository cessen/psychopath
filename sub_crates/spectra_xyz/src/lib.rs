...
pub fn spectrum_xyz_to_p(lambda: f32, xyz: (f32, f32, f32)) -> f32 {
    ...
    if inside {
        ...
        //  2  3
        //  0  1
        interpolated_p = p[0] * (1.0 - uv2.0) * (1.0 - uv2.1) + p[2] * (1.0 - uv2.0) * uv2.1 + p[3] * uv2.0 * uv2.1 + p[1] * uv2.0 * (1.0 - uv2.1);
    } else {
        ...
        for i in 0..(num as usize - 1) {
            let (e1x, e1y): (f32, f32) = if i as i32 == (num - 2) {
                // close the circle
                (SPECTRUM_DATA_POINTS[idx[1] as usize].uv.0 - SPECTRUM_DATA_POINTS[idx[0] as usize].uv.0, SPECTRUM_DATA_POINTS[idx[1] as usize].uv.1 - SPECTRUM_DATA_POINTS[idx[0] as usize].uv.1)
            } else {
                (SPECTRUM_DATA_POINTS[idx[i + 2] as usize].uv.0 - SPECTRUM_DATA_POINTS[idx[0] as usize].uv.0, SPECTRUM_DATA_POINTS[idx[i + 2] as usize].uv.1 - SPECTRUM_DATA_POINTS[idx[0] as usize].uv.1)
            };
...
const SPECTRUM_MAT_UV_TO_XY: [f32; 6] = [
    ...
    -0.02361291916573777,
    0.13292069743203658,
    0.022853819546830627,
    0.05077639329371236,
    -0.0068951571224999215,
];
// apply a 3x2 matrix to a 2D color.
fn spectrum_apply_3x2(matrix: &[f32; 6], src: (f32, f32)) -> (f32, f32) {
    (matrix[0] * src.0 + matrix[1] * src.1 + matrix[2], matrix[3] * src.0 + matrix[4] * src.1 + matrix[5])
}
...
const SPECTRUM_GRID: [SpectrumGridCell; 168] = [
    ...
    SpectrumGridCell {
        inside: false,
        num_points: 5,
        idx: [149, 10, 11, 145, 22, -1],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 5,
        idx: [150, 111, 12, 23, 112, -1],
    },
    SpectrumGridCell {
        inside: true,
        num_points: 4,
    ...
    SpectrumGridCell {
        inside: false,
        num_points: 5,
        idx: [151, 22, 145, 146, 33, -1],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 5,
        idx: [152, 112, 23, 34, 113, -1],
    },
    SpectrumGridCell {
        inside: true,
        num_points: 4,
    ...
    SpectrumGridCell {
        inside: false,
        num_points: 6,
        idx: [153, 32, 33, 147, 141, 43],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 4,
        idx: [154, 33, 146, 147, -1, -1],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 5,
        idx: [155, 113, 34, 44, 114, -1],
    },
    SpectrumGridCell {
        inside: true,
        num_points: 4,
    ...
    SpectrumGridCell {
        inside: false,
        num_points: 4,
        idx: [159, 115, 54, 116, -1, -1],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 6,
        idx: [160, 116, 54, 55, 64, 117],
    },
    SpectrumGridCell {
        inside: true,
        num_points: 4,
    ...
    SpectrumGridCell {
        inside: false,
        num_points: 6,
        idx: [161, 62, 63, 144, 138, 71],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 4,
        idx: [162, 63, 143, 144, -1, -1],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 0,
    ...
    SpectrumGridCell {
        inside: false,
        num_points: 6,
        idx: [166, 78, 79, 140, 134, 86],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 4,
        idx: [167, 79, 139, 140, -1, -1],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 0,
    ...
    SpectrumGridCell {
        inside: false,
        num_points: 4,
        idx: [168, 119, 80, 120, -1, -1],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 6,
        idx: [169, 80, 81, 87, 121, 120],
    },
    SpectrumGridCell {
        inside: true,
        num_points: 4,
    ...
    SpectrumGridCell {
        inside: false,
        num_points: 5,
        idx: [173, 122, 93, 99, 123, -1],
    },
    SpectrumGridCell {
        inside: true,
        num_points: 4,
        idx: [93, 94, 99, 100, -1, -1],
    },
    SpectrumGridCell {
        inside: true,
        num_points: 4,
        idx: [94, 95, 100, 101, -1, -1],
    },
    SpectrumGridCell {
        inside: true,
        num_points: 4,
        idx: [95, 96, 101, 102, -1, -1],
    },
    SpectrumGridCell {
        inside: true,
        num_points: 4,
        idx: [96, 97, 102, 103, -1, -1],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 6,
        idx: [174, 97, 98, 137, 131, 103],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 4,
        idx: [175, 98, 136, 137, -1, -1],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 0,
    ...
    SpectrumGridCell {
        inside: false,
        num_points: 4,
        idx: [176, 123, 99, 124, -1, -1],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 6,
        idx: [177, 124, 99, 100, 104, 125],
    },
    SpectrumGridCell {
        inside: true,
        num_points: 4,
        idx: [100, 101, 104, 105, -1, -1],
    },
    SpectrumGridCell {
        inside: true,
        num_points: 4,
        idx: [101, 102, 105, 106, -1, -1],
    },
    SpectrumGridCell {
        inside: true,
        num_points: 4,
        idx: [102, 103, 106, 107, -1, -1],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 5,
        idx: [178, 103, 131, 132, 107, -1],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 0,
    ...
    SpectrumGridCell {
        inside: false,
        num_points: 4,
        idx: [179, 125, 104, 126, -1, -1],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 6,
        idx: [180, 104, 105, 108, 127, 126],
    },
    SpectrumGridCell {
        inside: true,
        num_points: 4,
        idx: [105, 106, 108, 109, -1, -1],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 6,
        idx: [181, 106, 107, 133, 129, 109],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 4,
        idx: [182, 107, 132, 133, -1, -1],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 0,
    ...
    SpectrumGridCell {
        inside: false,
        num_points: 4,
        idx: [183, 127, 108, 128, -1, -1],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 5,
        idx: [184, 108, 109, 130, 128, -1],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 4,
        idx: [185, 109, 129, 130, -1, -1],
    },
    SpectrumGridCell {
        inside: false,
        num_points: 0,
